...
<p align="center">
  <img src="https://img.shields.io/badge/版本-0.9.0--beta.3-5B7CFA?style=flat-square" alt="版本 0.9.0-beta.3">
...
当前版本为 **0.9.0-beta.3 公开测试版**。它首次把全盘即时文件搜索、目录解释、AI 辅助识别、空间变化追踪、垃圾清理和 Windows 官方系统维护整合到同一套桌面体验中。安装版、便携版和 SHA-256 校验文件会随 GitHub Release 一同提供。
