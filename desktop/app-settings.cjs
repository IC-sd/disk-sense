...
const OWNED_DATA_FILES = [
  ...
  'disk-sense-state.json.operations.json',
  'disk-sense-state.json.operations.json.bak',
  'disk-sense-state.json.analyses.json',
  'disk-sense-state.json.analyses.json.bak',
